...
def main():
    ...
    parser.add_argument("--openai", action="store_true", help="Usar OpenAI (gpt-4.1, gpt-4o, gpt-4o-mini). Ou defina env OPENAI_API_KEY")
    parser.add_argument("--openai-key", default="", help="Chave da API OpenAI. Ou env OPENAI_API_KEY")
    parser.add_argument("--openai-model", default="", help="Modelo OpenAI (default: gpt-4o-mini). Ex.: gpt-4.1, gpt-4o, gpt-4o-mini. Ou env OPENAI_MODEL")
